        ...
        <div class="flex justify-between w-full">
          ...
          <div class="flex items-end space-x-3">
            ...
            <!-- <UDropdownMenu :items="items" :content="{ align: 'start' }" :ui="{ content: 'w-48' }" v-model:open="open"> 
                      <div class="rounded-3xl px-3 py-1  shadow text-white  bg-gradient-to-b from-pool-400 to-pool-400/55 items-center flex space-x-2 cursor-pointer">
                    
                        <NuxtImg format="webp"  :src="imgSrc" width="30" placeholder v-if="imgSrc !== ''"/>
                        <div class="flex flex-col px-1">
                          <p class="text-sm">{{$auth_user.name ?? ""}} </p> 
